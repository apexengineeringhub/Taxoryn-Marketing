  ...
  return (
    <div className="py-10 sm:py-16 bg-[#F8FAFC]">
      <Container>
        ...
        <div className="max-w-3xl mx-auto p-3.5 sm:p-4 rounded-xl bg-white border border-slate-200 shadow-sm text-xs sm:text-sm text-slate-700 text-center flex items-center justify-center gap-2 mb-8 sm:mb-10">
        ...
        <div className="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm space-y-5 mb-10 sm:mb-14">

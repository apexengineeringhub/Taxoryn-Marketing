    ...
    <div className="py-10 sm:py-16 bg-[#F8FAFC]">
      <Container>
        ...
        <div className="mb-10 sm:mb-14">
          <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-[#07152B] to-[#082E5B] text-white border border-slate-800 shadow-xl flex flex-col md:flex-row items-center justify-between gap-5">
            <div className="space-y-1.5 text-center md:text-left max-w-xl">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#00D1A3]/20 border border-[#00D1A3]/40 text-[#00D1A3] text-[11px] font-semibold">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2.5 shrink-0">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#00D1A3] text-[#07152B] font-bold text-xs hover:bg-[#00FFC2] shadow-md transition-all duration-200"
              >
              ...
              <Link
                href="/videos"
                className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-slate-800 text-slate-200 hover:bg-slate-700 font-semibold text-xs border border-slate-700 transition-all duration-200"
              >

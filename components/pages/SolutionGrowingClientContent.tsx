...
export function SolutionGrowingClientContent() {
  const { t } = useLanguage();
  const page = t.pages.solutionsPages.growing;
        ...
        <Container>
          ...
          <div className="max-w-4xl mx-auto p-5 sm:p-6 rounded-2xl bg-white border border-slate-200/90 shadow-sm space-y-4 mb-8 sm:mb-10">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              ...
              <span className="text-xs px-2.5 py-0.5 rounded-full bg-emerald-50 text-[#009E77] font-mono font-bold border border-emerald-100">
                {page.visualTag}
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">
                ...
                <div className="text-[#009E77] text-[10px] font-semibold">{page.stat1Sub}</div>
              </div>
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 space-y-1">

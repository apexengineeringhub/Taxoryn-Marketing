        ...
        <Container>
          <div className="max-w-3xl mx-auto space-y-10">
            ...
            <div className="space-y-3 text-center">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-extrabold text-[#07152B] tracking-tight leading-tight">
                {page.title}
              </h1>
            ...
            {/* Narrative Body */}
            <div className="p-6 sm:p-10 rounded-2xl bg-white border border-slate-200/90 shadow-sm space-y-7 text-slate-700 text-sm sm:text-base leading-relaxed font-normal">

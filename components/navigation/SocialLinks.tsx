...
import { siteConfig, getActiveSocialLinks, ActiveSocialLink } from "@/lib/config/site";
import { useLanguage } from "@/lib/i18n/LanguageContext";
import { cn } from "@/components/common/Container";
import { SocialPlatform } from "@/types";

// Pixel-perfect recognizable brand SVGs
...
export function SocialLinks({
  ...
  const { t } = useLanguage();
  const activeLinks = getActiveSocialLinks(siteConfig.socialLinks);
    ...
    >
      {activeLinks.map((link: ActiveSocialLink) => {
        ...
        const accessibleLabel =
          (t.footer.social && t.footer.social[platform]) ||
          (platform === "youtube"
            ? "Taxoryn on YouTube"
            : platform === "linkedin"
            ? "Taxoryn on LinkedIn"
            : platform === "instagram"
            ? "Taxoryn on Instagram"
            : "Taxoryn on Facebook");
        ...
        return (
          <a
            ...
            className={cn(defaultStyles, itemClassName)}
          >
